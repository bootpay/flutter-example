...
class BootpayEnvConfig {
  ...
  static String get devClientKey {
    final fromEnv = _envOrEmpty('BOOTPAY_CLIENT_KEY_DEV');
    return fromEnv.isNotEmpty ? fromEnv : _devClientKey;
  }

  static String get prodClientKey {
    final fromEnv = _envOrEmpty('BOOTPAY_CLIENT_KEY_PROD');
    return fromEnv.isNotEmpty ? fromEnv : _prodClientKey;
  }
}
